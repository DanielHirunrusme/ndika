...
<?php
	// echo $this->Form->create('SiteProfile', array('action'=>'addFavicon','type'=>'file', 'inputDefaults' => array('label' =>false , 'div' => false)));
	// echo $this->Form->end();
...
<div align="right" class="cms_PageButton">
	...
	<input type="button" value="Cancel" class="isOff" onclick="javascript: window.location=site+'pages/'">
		...
		<div class="splitRight">
			...
			<div class="cms_Module">
				<h5 class="cms_SidebarTitle">Fav Icon</h5>
				<ul class="cms_SidebarList">
					
					<li class="isUpload">
						<?php
							echo $form->create('SiteProfile', array('action'=>'uploadFavicon','type'=>'file','class'=>'notif-change'));
						?>
						<?php echo $this->Form->input('Media.name',array('size'=>'14','type'=>'file','div'=>false,'label'=>false));?>
						<input id="button-submit" type="button" value="Upload" class="isSmall alignRight">
						<?php
							echo $this->Form->end();						
						?>
						<div class="clearFix"></div>
